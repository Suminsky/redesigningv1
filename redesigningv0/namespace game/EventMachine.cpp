...
//bool EventMachine::DispatchEventImmetiately( EventType type_p, INT_PTR data_p, INT_PTR data2_p, std::shared_ptr<void> && pData3_p/* = nullptr*/ )
//{
//	// build event
//
//	Event immEvent(type_p, data_p, data2_p, std::move(pData3_p));
//
