 ...
 *union STATEMASK{
 ...
 bool	IA_InputLayout :1;

 bool	IA_VertexBuffer0 :1; // up to 16
 bool	IA_VertexBuffer1 :1;
 bool	IA_VertexBuffer2 :1;
 bool	IA_VertexBuffer3 :1;
 bool	IA_VertexBuffer4 :1;

 bool	IA_IndexBuffer :1;
 bool	IA_PrimitiveTopology :1;

 bool	VS_VertexShader :1;
 bool	PS_PixelShader :1;
 bool	GeometryShader :1;

 bool	VS_CBuffer0 :1;	// Each shader stage allows up to 15 shader-constant buffers; each buffer can hold up to 4096 constants.
 bool	VS_CBuffer1 :1;
 bool	VS_CBuffer2 :1;
 bool	VS_CBuffer3 :1;
 ...
 bool	VS_ShaderResourceView0 :1;	// 128 texture buffers!
 bool	VS_ShaderResourceView1 :1;
 bool	VS_ShaderResourceView2 :1;
 bool	VS_ShaderResourceView3 :1;

 bool	GS_ShaderResourceView0 :1;
 bool	GS_ShaderResourceView1 :1;
 bool	GS_ShaderResourceView2 :1;
 bool	GS_ShaderResourceView3 :1;

 bool	PS_ShaderResourceView0 :1;
 bool	PS_ShaderResourceView1 :1;
 bool	PS_ShaderResourceView2 :1;
 bool	PS_ShaderResourceView3 :1;

 bool	VS_Sampler0 :1;	// 128 sampler buffers!
 bool	VS_Sampler1 :1;
 bool	VS_Sampler2 :1;
 bool	VS_Sampler3 :1;
 ...
 bool	RS_ViewPort :1;
 bool	RS_RasterizerState :1;

 bool	OM_RenderTargetDepthStencil :1;
 bool	OM_DepthStencilState :1;
 bool	OM_BlendState :1;
 } bitField;
 };
 ...
 bool	IA_InputLayout :1;
 UINT	IA_VertexBuffer :4; // up to 16
 bool	IA_IndexBuffer :1;
 bool	IA_PrimitiveTopology :1;
 ...
 UINT	VS_CBuffer :4;	// Each shader stage allows up to 15 shader-constant buffers; each buffer can hold up to 4096 constants.
 UINT	GS_CBuffer :4;
 UINT	PS_CBuffer :4;

 UINT	VS_ShaderResourceView :4;	// 128 texture buffers!
 UINT	GS_ShaderResourceView :4;
 UINT	PS_ShaderResourceView :4;

 UINT	VS_Sampler :3;	// 128 sampler buffers!
 UINT	GS_Sampler :3;
 UINT	PS_Sampler :3;
...
E_VS_CBuffer0,	// Each shader stage allows up to 15 shader-constant buffers; each buffer can hold up to 4096 constants.
E_VS_CBuffer1,
E_VS_CBuffer2,
E_VS_CBuffer3,
...
E_VS_ShaderResourceView0,	// 128 texture buffers!
E_VS_ShaderResourceView1,
E_VS_ShaderResourceView2,
E_VS_ShaderResourceView3,
...
E_VS_Sampler0,	// 128 sampler buffers!
E_VS_Sampler1,
E_VS_Sampler2,
E_VS_Sampler3,
...
E_OM_RenderTargetDepthStencil,	// up yo 8 rts, but at the same time and always overwrite everyone already bound

E_RS_ViewPort,	// 16 viewports can be bound, but only one can be active
// To perform a per-primitive selection of the viewport in the geometry shader,
// specify the ViewportArrayIndex semantic on the appropriate GS output component in 
// the GS output signature declaration.
